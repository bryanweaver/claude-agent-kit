...
export async function init(options = {}) {
  ...
  // Step 7-9: Install commands, hooks, and skills
  const assetGroups = [
    { label: 'commands', subdir: 'commands', ext: '.md', copyFn: copyFile },
  ...
  console.log();
  console.log(chalk.gray('  Commands:'), chalk.white(`${installCounts.commands} installed`));
