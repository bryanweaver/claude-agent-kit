 ...
 * @param {string} type - Type of asset (agent, hook, skill)
...
/**
 * Install agents, hooks, and skills to Claude Code directory
...
export async function install(options = {}) {
  ...
  try {
    ...
    console.log(chalk.blue('\nRestart Claude Code to use the new agents and skills.\n'));
