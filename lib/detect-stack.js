  ...
  return [
    {
      ...
      tags: ['frontend', 'backend', 'database', 'fullstack']
    },
    {
      id: 'react-express-postgres',
      name: 'React + Express + PostgreSQL',
      description: 'Traditional MERN-style stack with PostgreSQL instead of MongoDB',
    ...
    },
    {
      ...
      description: 'Full-featured Python web framework with Django ORM',
      languages: ['python'],
    ...
    },
    {
      ...
      description: 'Modern async Python API framework with automatic OpenAPI docs',
      languages: ['python'],
    ...
    },
    {
      ...
      description: 'Vue.js frontend with Node.js backend and MongoDB',
      languages: ['typescript', 'javascript'],
      tags: ['frontend', 'backend', 'database', 'nosql']
    },
    {
      id: 'node-generic',
      name: 'Node.js (Generic)',
      description: 'Generic Node.js/TypeScript development',
      languages: ['typescript', 'javascript'],
      tags: ['backend', 'generic']
    },
    {
      id: 'python-generic',
      name: 'Python (Generic)',
      description: 'Generic Python development',
      languages: ['python'],
      tags: ['backend', 'generic']
    }
  ];
